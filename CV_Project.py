# -*- coding: utf-8 -*-
"""
Created on  Feb  2 02:52:44 2021
...
if __name__ == '__main__': 
    ...
    DIR_INPUT = r"E:\uzair\uzair\home\Nust\Thesis\code\prediction"
    os.environ["L5KIT_DATA_FOLDER"] = DIR_INPUT
    dm = LocalDataManager(None)
    cfg = load_config_data("./motion_config.yaml")
    # In[]
    # ===== INIT TRAIN DATASET============================================================
    ...
    model.to(device)
    optimizer = optim.Adam(model.parameters(), lr=float(cfg["model_params"]["lr"]))
    print(model)
    # In[] # ==== TRAINING LOOP =========================================================
